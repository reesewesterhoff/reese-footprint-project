...
('Emergency Medical Center', '24/7 emergency center with stabilization and referral capabilities. Electicity needed for lighting, cold chain, lab, office, communciations, and HVAC.', 150, 30, 16, 100, 20, 140000, 'Health'),
('Hospital', 'Comprehensive medical center with primary, emergency and surgical capabilities. Electricity needed for lighting, cold chain, lab, office, communications, HVAC, surgical and sophisticated diagnotic services.', 1000, 200, 100, 200, 140, 800000, 'Health'),
...
('School Shelter', 'Lighting and Communication', 50, 20, 16, 60, 20, 120000, 'Shelter'),
...
-- Total Cost in Large Shelter is Dummy Data, will update when cost is available
('Large Shelter', 'Shelter space for large groups', 50,	20,	16,	60,	20, 100000, 'Shelter'), 
